...
int main(int argc, char *argv[]) {
    ...
    /* parse the file to load the movies */
    ...
    index_sorted = array_sorted_until(movielist, length);
    if (index_sorted == length -1) {
        printf("Movielist is sorted\n");
    } else {
        printf("Movielist is sorted until %u", index_sorted);
    }
